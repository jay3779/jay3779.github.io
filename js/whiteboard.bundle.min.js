...
/***/ (function(module, exports, __webpack_require__) {
	...
	var ng;
	if (typeof angular === 'undefined' && "function" !== 'undefined') {
	  ng = __webpack_require__(1);
	} else {
	  ng = angular;
	}
	var initLayoutContainer;
	if (!window.hasOwnProperty('initLayoutContainer') && "function" !== 'undefined') {
	  initLayoutContainer = __webpack_require__(6).initLayoutContainer;
	} else {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	**/
	...
	if (typeof paper === 'undefined' && "function" !== 'undefined') {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!../css-loader/index.js!./opentok-whiteboard.css", function() {
				var newContent = require("!!../css-loader/index.js!./opentok-whiteboard.css");
	...
	angular.module('opentok-meet').factory('RoomService', ['$http', 'baseURL', '$window', 'room',
	  function ($http, baseURL, $window, room) {
	    return {
	        ...
	        return new Promise((resolved, reject) => {
	          ...
	          try {
	            ...
	            if (getQueryVariable('token')) {
	              ...
	              $.ajax({
	                url: baseURL + '/host/' + window.localStorage.getItem('username') + '/room/' + window.localStorage.getItem('room'),
	                type: 'get',
	                headers: {
	      ...
	      startArchiving: function (sessionId, options) {
	        return new Promise((resolved, reject) => {
	          $.ajax({
	            url: baseURL + '/archive/start/' + sessionId,
	            type: 'POST',
	            headers: {
	              'content-type': 'application/x-www-form-urlencoded',
	              'Authorization': window.localStorage.getItem('authorization')
	          ...
	          }).done(resolved).fail(reject);
	        });
	      },
	      stopArchiving: function(archiveId) {
	        return new Promise((resolved, reject) => {
	          $.ajax( {
	            url: baseURL + '/archive/stop/' + archiveId,
	            type: 'get',
	            headers: {
	              'content-type': 'application/x-www-form-urlencoded',
	              'Authorization': window.localStorage.getItem('authorization')
...
/***/ (function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!../../node_modules/css-loader/index.js!./whiteboard.css", function() {
				var newContent = require("!!../../node_modules/css-loader/index.js!./whiteboard.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
//# sourceMappingURL=whiteboard.bundle.min.js.map